...
export function createStyles(t: Theme) {
  return StyleSheet.create({
    ...
    // Export has eleven choices on web. A wide, bounded dialog lets the three format
    // families scan as columns and keeps the surface inside short laptop viewports.
    exportModalCard: {
      width:             '100%',
      maxWidth:          900,
      maxHeight:         '88%',
      ...
      overflow:          'hidden',
      ...(Platform.OS === 'web'
        ? { boxShadow: t.isDark ? '0 24px 64px rgba(0,0,0,0.55)' : '0 24px 64px rgba(0,0,0,0.22)' } as any
        : null),
    } as ViewStyle,
    exportModalHeader: {
      flexDirection:     'row',
    ...
    exportModalSubtitle: { fontSize: FONT.xs, fontFamily: Poppins.regular, color: t.textMuted },
    exportModalClose: {
      width: 36,
      height: 36,
      borderRadius: 8,
    ...
    exportModalScroll: { flexShrink: 1 },
    exportModalContent: { padding: 24, gap: 20 },
    exportModalSections: { gap: 18 },
    exportModalSection: { gap: 8 },
    exportModalTileGroup: {
      flexDirection: 'row',
      flexWrap: 'wrap',
      gap: 10,
    },
    ...
    exportModalSelection: { flex: 1, gap: 1, minWidth: 0 },
    exportModalSelectionName: { fontSize: FONT.sm, fontFamily: Poppins.semiBold, color: t.textPrimary },
    exportModalSelectionDescription: { fontSize: FONT.xs, fontFamily: Poppins.regular, color: t.textMuted },
    exportModalShareBtn: {
      minWidth: 110,
      flexDirection: 'row',
      alignItems: 'center',
    ...
    exportModalShareBtnText: { fontSize: 12, fontFamily: Poppins.bold, color: t.textSub },
    exportModalDownloadBtn: {
      minWidth: 140,
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'center',
    ...
    exportModalDownloadBtnText: { fontSize: 12, fontFamily: Poppins.bold, color: '#fff' },
    ...
    exportInstrumentRowActive: { borderColor: t.accent },
    exportInstrumentCopy: { flex: 1, gap: 1 },
    exportInstrumentName: { fontSize: 12, fontFamily: Poppins.bold, color: t.textPrimary },
    exportInstrumentHint: { fontSize: 10, fontFamily: Poppins.regular, color: t.textMuted },
